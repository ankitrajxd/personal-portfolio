...
const CodeBlock = () => {
  return (
    <div className="bg-zinc-900 max-w-[700px] m-auto rounded-lg  border relative text-sm">
      ...
      <div className="px-5 py-8 border-zinc-600 overflow-hidden">
        <code className="font-jetbrains">
          ...
          <div data-aos="fade-in-left" data-aos-delay="300">
            ...
            <span className="text-white ml-9 mr-2">hardWorker:</span>
            <span className="text-orange-400">true</span>
            <span className="text-gray-400">,</span>
          </div>
          <div data-aos="fade-in-left" data-aos-delay="400">
            <span className="text-zinc-500">5</span>
            <span className="text-white ml-9 mr-2">problemSolver:</span>
            <span className="text-orange-400">true</span>
            <span className="text-gray-400">,</span>
          </div>
          <div data-aos="fade-in-left" data-aos-delay="500">
            <span className="text-zinc-500">6</span>
            <span className="text-green-400 ml-9 mr-2">hireable:</span>
