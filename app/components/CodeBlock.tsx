...
const CodeBlock = () => {
  return (
    <>
      ...
      <div className="bg-zinc-950 max-w-[700px] m-auto  border border-dashed relative text-sm">
        ...
        <div className="px-5 py-5 flex items-center justify-between border-b border-dashed">
